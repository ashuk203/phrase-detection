    ...
    # find patterns around seed phrases
            ...
            # add context pattern
                ...
                for i in range(5, 0, -1):
                    if (document[start - i].text == '\n' or document[start - i].text == '.'):
                        tmp = []
                    else:
                ...
                for i in range(0, 5):
                    if (document[end + i].text == '\n' or document[end + i].text == '.' or document[end + i].tag_[0:2] == "VB"):
                        break
                    tmp.append({"TEXT": document[end + i].text})
